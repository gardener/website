...
([`example/aks/tiller-rbac-config.yaml`](https://raw.githubusercontent.com/gardener/gardener/master/docs/deployment/../../example/aks/tiller-rbac-config.yaml)).
...
The [`example/aks/etcd.yaml`](https://raw.githubusercontent.com/gardener/gardener/master/docs/deployment/../../example/aks/etcd.yaml) file used
here is a modified version of the etcd manifest used in
[hack/dev-setup](https://raw.githubusercontent.com/gardener/gardener/master/docs/deployment/../../hack/dev-setup) script to stay close to dev
...
[`example/aks/gardener-values.yaml`](https://raw.githubusercontent.com/gardener/gardener/master/docs/deployment/../../example/aks/gardener-values.yaml)
...
Update the fields in [`example/90-shoot-azure.yaml`](https://raw.githubusercontent.com/gardener/gardener/master/docs/deployment/../../example/90-shoot-azure.yaml):
...
the [hack/delete-shoot](https://raw.githubusercontent.com/gardener/gardener/master/docs/deployment/../../hack/delete-shoot) for this purpose.
