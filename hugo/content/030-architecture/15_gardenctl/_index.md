...
# What is gardenctl?
`gardenctl` is a command-line client for administrative purposes for the [Gardener](https://github.com/gardener/gardener). It facilitates the administration of or one many garden, seed and shoot clusters, e.g. to check for issues which occured in one of these clusters. Details about the concept behind the Gardener are described in the [Gardener wiki]({{< ref "/030-architecture/_index.md" >}}).
...
git clone {{< ref "/030-architecture/15_gardenctl/_index.md" >}}
cd gardenctl
