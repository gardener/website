...
This project contains a [terraform environment](https://raw.githubusercontent.com/gardener/kubify/master/doc/files.md) to setup a kubernetes
...
The target cluster can be enriched by a set of predefinied [addons](https://raw.githubusercontent.com/gardener/kubify/master/doc/addons.md) that comes out of the box
...
- Add the kubify repository as a git submodule with the name `k8s`.
  ...
  ```
  git submodule add {{< ref "/030-architecture/30_kubify/_index.md" >}} k8s
  git submodule init
  ```
...
First of all there are required settings for every IaaS environment:
  - [Openstack](https://raw.githubusercontent.com/gardener/kubify/master/doc/openstack.md)
  - [AWS](https://raw.githubusercontent.com/gardener/kubify/master/doc/aws.md)
  - [Azure](https://raw.githubusercontent.com/gardener/kubify/master/doc/azure.md)
...
Several [addons](https://raw.githubusercontent.com/gardener/kubify/master/doc/addons.md) can be chosen for optional deployment.
...
|Name|Meaning|
|--|--|
|addons|map with addon and their configuration settings (see [addons](https://raw.githubusercontent.com/gardener/kubify/master/doc/addons.md))
...
Actual settings can be found [here](https://raw.githubusercontent.com/gardener/kubify/master/modules/vms/versions.tf).
...
Actual versions are defined [here](https://raw.githubusercontent.com/gardener/kubify/master/modules/versions/defaults.tf).
...
[`migration.mig`](https://raw.githubusercontent.com/gardener/kubify/master/migrate.mig)  that is used by the command
